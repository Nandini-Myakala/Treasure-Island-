...
if choice1 == "left":
    ...
    if choice2 == "wait":
        ...
        if choice3 == "red":
            ...
            print("You have enter a room of beasts. Game Over")
        else:
            print("You chosed a room that does not exist. Game Over")
    else:
        print("you have attacked by am angry trout.Game Over")
else:
